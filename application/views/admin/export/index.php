  ...
  <main>
    ...
    <div class="container-xl px-4">
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <form action="<?= base_url('export/sarprasPrint') ?>" method="post" id="formGeneral">

            <div class="modal-body">

              <div class="mb-3">
                <span class="form-label">Pilih Periode</span>
                <div class="icon-options mt-3">
                  <select class="form-control" name="tahun_ajaran" id="tipe" type="text" placeholder="Masukkan jenis Informasi" required>
                    <option value="">Pilih Periode</option>
                    <?php foreach ($tahun_ajaran as $ta) : ?>
                      <option value="<?= $ta['id'] ?>"><?= $ta['nama'] ?></option>
                    <?php endforeach; ?>
                  </select>
                  <!-- <input class="input" type="date" name="tgl_awal" id=""> -
                  <input type="date" name="tgl_akhir" id=""> -->
                </div>
              </div>
